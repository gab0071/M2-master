...
// Usando querySelector seleccionar dicho span por su id ('c') y luego usando innerHTML
// agregar tu nombre al final del texto actual. Ej: 'Aplicación creada por Franco'
// Tu código acá:
var spanName = document.querySelector('span#createdBy');
spanName.innerHTML = ('<span></span>');
spanName.append('Aplicación creada por: catella');


// Crear una clase denominada 'ToDo' cuyo constructor debe recibir 
//un único parámetro del
// tipo string
// 
//  con el nombre 'description' que será justamente la descripción del ToDo.
// Agregar dos propiedades a la clase:
// 1) 'description' : debe ser igual a la descripción pasada como parámetro
// al 
//constructor
...
//  5) Al final de este archivo, antes de la línea que dice "NO CAMBIES NADA DE ACÁ PARA ABAJO"
//  escribe una   línea para hacer el llamado a esta funcion (displayToDos)
...
// Todos los elementos input tienen una propiedad llamada 'value' que nos permite acceder
// al texto que se encuentre actualmente escrito dentro del input]
...
//  3) Setear el valor del input toDoInput como un string vacio ("") (Esto se realiza para 
//que en la vista se borre lo que se encontraba escrito)
